...
<head>
    ...
    <title> PW | AVISO DE COOKIE </title>

    <link rel="stylesheet" href="avcookies.css" />
    ...
    <main class="conteudo">
        ...
        <div class="sseccao-de-cookies" id="sseccao-de-cookies">
            ...
            <div class="aviso-de-cookie">
                <img src="imagens/imagem-cookie.png" alt="IMAGEM DE COOKIE">
                ...
                <?php if ($usuarioLogado) : ?>
                    <a class="btn-buttons" type="submit" name="definirCookie">Editar Cookie</button>
                <?php else : ?>
                  <br>
